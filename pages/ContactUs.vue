<template>
    <div class="container">
       <div class="row">
            <div class="contact-left-container col-lg-6">
                <div class="contact-left">
                    <div class="content">
                        <h5>contact us</h5>
                        <h3>Get in touch with us</h3>
                        <p>Have a question or need a feedback or an enquiry about a product or brand, reach out to us today</p>
                    </div>
                    <div class="contact-email-container">
                        <div class="contact-email">
                            <h6>Write us an email</h6>
                            <p>thevault2024@gmail.com</p>
                        </div>
                    </div>
                    <div class="social-media-container">
                        <div class="social-media">
                            <h6>Reach out on any of our socials</h6>
        ...
        <div class="contact-right-container col-lg-6">
                <div class="contact-right">
                    <form @submit.prevent="handleSubmit">
                        ...
                        <div class="message">
                            <textarea class="input" placeholder="MESSAGE" rows="10" cols="10" ></textarea>
                        </div>
